...
const int bluetoothRxPin = 0; // RX pin of Bluetooth module connected to Pin 0 (Rx)
const int bluetoothTxPin = 1; // TX pin of Bluetooth module connected to Pin 1 (Tx)
...
void loop()
{
    ...
    while (millis() - startTime < minDuration)
    {
        ...
        delay(100); // Check distance and Bluetooth data every 100 milliseconds
    }
